...
\begin{figure}[h]
\centering
\includegraphics[height=.4\textwidth]{images/logo.png}
\caption{Das Logo der \companyName\footnotemark}
\end{figure}

\section{Test section}
\subsection{Ich bin eine Subsection}
