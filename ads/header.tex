...
\usepackage{wrapfig}
% bibliograhie
\usepackage[hang, multiple, stable, bottom]{footmisc}
\usepackage{chngcntr}
...
% Map citationStyle to biblatex options
\IfStrEqCase{\citationStyle}{%
  {ieee}{%
    \newcommand{\mybibstyle}{ieee}%
    \newcommand{\mybibautocite}{inline}%
  }%
  {harvard}{%
  ...
  {footnote}{%
    \newcommand{\mybibstyle}{authoryear}%
    \newcommand{\mybibautocite}{footnote}%
  }%
}[%
...
\iflang{de}{%
  \usepackage[
    ...
    dashed=false,
    style=\mybibstyle,
    autocite=\mybibautocite,
    backref=true, % Adds back references in the bibliography to the pages where the source was cited
  ]{biblatex}
...
% \addbibresource{T1000.bib}

% Prevent widows and orphans
% http://projekte.dante.de/DanteFAQ/Silbentrennung
\clubpenalty = 10000 % Prevents orphans (page break after the first line of a new paragraph)
\widowpenalty = 10000 % Prevents widows (the last line of a paragraph is on a new page)
